...
def test_api_connection(api_key: str, model_name: str = "gemini-2.0-flash-exp"):
    """
...
if __name__ == "__main__":
    """
    Test the ethics framework functions directly
    """
    print("Testing Gemini Ethics Framework...")
    print("=" * 50)
    ...
    print("🎉 Ethics framework ready for testing!")